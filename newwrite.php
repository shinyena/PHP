...
<head> 
    ...
    * { padding: 0; margin: 0;}
    ...
    #write #upfile {height: 30px; padding: 10px;}
...
<body>
    ...
    <div id="box">
        ...
        <form id="write" name="write" method="post" action="newwrite_insert.php" enctype="multipart/form-data">
            <span style="font-weight: bold"><?=$logged?></span>
            <textarea id="content" name="content" placeholder="내용을 입력하시오"></textarea>
